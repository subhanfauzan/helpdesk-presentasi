...
(function (b) {
    ...
    var k = b.fn.dataTable, w = 0, t = function (a, d) {
        ...
        this.dom = {
            ...
            header: {
                host: null, floating: null, floatingParent: b('<div class="dtfh-floatingparent" id="data_test">'),
                placeholder: null
            },
            footer: {
                host: null,
    ...
    b.extend(t.prototype, {
        ...
        footerOffset: function (a) {
            ...
            this._scroll()
                             ...
                             d) {
            var c = this, f = this.s.dt, e = this.dom[a], n = "header" === a ? this.dom.thead : this.dom.tfoot;
            if ("footer" !== a || !this._scrollEnabled()) if (!d && e.floating) e.floating.removeClass("fixedHeader-floating fixedHeader-locked"); else {
                ...
                var p = b(f.table().node()), r = b(p.parent()), m = this._scrollEnabled();
                e.floating = b(f.table().node().cloneNode(!1)).attr("aria-hidden",
                    "true").css({"table-layout": "fixed", top: 0, left: 0}).removeAttr("id").append(n);
            ...
            var c = function (n) {
                ...
                b(n, d).each(function (p) {
                    b(this).css({width: q[p], minWidth: q[p]})
                })
            }, e = c("th");
            c = c("td");
            f("th", e);
            ...
            var f = this.dom[d],
                e = this.s.position, n = this._scrollEnabled();
            if ("footer" !== d || !n) {
                var q = function (B) {
                ...
                if ("in-place" === a) f.placeholder && (f.placeholder.remove(), f.placeholder = null), this._unsize(d), "header" === d ?
                    f.host.prepend(p) : f.host.append(p), f.floating && (f.floating.remove(), f.floating = null, this._stickyPosition(f.host, "+")), f.floatingParent && f.floatingParent.remove(), b(b(f.host.parent()).parent()).scrollLeft(m.scrollLeft()); else if ("in" === a) {
                    this._clone(d, c);
                    p = m.offset();
                    c = b(g).scrollTop();
                    var u = b(h).height();
            ...
            d = b(d.node());
            var e = this._scrollEnabled(), n = b(a.table().header());
            a = b(a.table().footer());
            f = f.tbody;
            var q = d.parent();
            ...
            if (!this.s.dt.settings()[0].bDestroying) {
                var d = this._scrollEnabled(), c = b(this.s.dt.table().node()).parent(), f = c.offset(),
                    e = c.outerHeight(), n =
                        b(g).scrollLeft(), q = b(g).scrollTop(), p = b(h).height(), r = p + q, m = this.s.position,
                ...
                this.c.footer && this.dom.tfoot.length && (this.s.enable ? !m.visible || m.tfootBottom + this.c.footerOffset <= r ? m = "in-place" : e + m.tfootHeight + this.c.footerOffset > r && u + this.c.footerOffset < r ? (m = "in", a = !0) : m = "above" : m = "in-place", (a || m !== this.s.footerMode) && this._modeChange(m,
                    "footer", a), this._horizontal("footer", n), a = function (A) {
