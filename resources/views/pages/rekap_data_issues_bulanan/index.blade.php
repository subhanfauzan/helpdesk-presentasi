        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Rekap Data Issues Bulanan</h4>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="form-control" id="tanggal_awal"
                                                                    name="tanggal_awal" value="{{ date('Y-m') }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6">
            ...
            <div class="modal-body">
                <form action="#" class="form-validate is-alter" name="formToPDF" id="formToPDF">
                    ...
                    <div class="form-group">
                        ...
                        <label class="form-label" for="full-name">Nama Koordinator Tim Helpdesk</label>
                        <div class="form-control-wrap">
                        ...
                        <div class="row mt-3" style="overflow-y: scroll; height:270px;">
                            ...
                            @foreach($checkbox_layanan as $data_checkbox_1 => $value)

                                <div class="form-control-wrap">
                                    <label class="form-label mt-2" for="full-name">{{$data_checkbox_1}}</label>
                                    @foreach($value as $data_checkbox_2)
                                    <div class="form-check">
                                        <input onclick="changeURL()" class="form-check-input checkbox_layanan" type="checkbox" id="checkbox_layanan" name="checkbox_layanan[]" value="{{explode('|',$data_checkbox_2)[0]}}" checked>
                                        <label class="form-check-label">{{explode("|",$data_checkbox_2)[1]}}</label>
                                    </div>
                                    @endforeach
                                </div>
                            ...
                            <!-- <div class="col">coba 2</div>
                            <div class="col">coba 3</div> -->
                        </div>
...
<script>
    ...
    function changeURL() {
        ...
        var checkbox_layanan = $('#checkbox_layanan').val();

        var val_checkbox_layanan = [];
        $('.checkbox_layanan:checked').each(function(i){
            val_checkbox_layanan[i] = $(this).val();
        });

        var checkbox_layanan_string = val_checkbox_layanan.toString();
        var checkbox_layanan_string_1 = checkbox_layanan_string.replaceAll(',', '&checkbox_layanan=');
        var checkbox_layanan_string_2 = '&checkbox=' + checkbox_layanan_string;

        // console.log('checkbox_layanan = ' + val);
        // console.log('&checkbox=' + checkbox_layanan_string_1);
        ...
        var data = "tanggal_awal=" + awal + "&tanggal_akhir=" + akhir + checkbox_layanan_string_2;
